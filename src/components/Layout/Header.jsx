...
const Header = ({ sidebarOpen, setSidebarOpen }) => {
  ...
  const notifications = [
    ...
    { id: 3, message: 'Monthly report ready', time: '3 hours ago', unread: false },
  ];
      ...
      <div className="flex items-center justify-between px-4 py-3">
        ...
        <div className="flex items-center space-x-3">
          ...
          <div className="relative">
            ...
            {notificationsOpen && (
              <div className={`absolute right-0 mt-2 w-80 rounded-lg shadow-lg border overflow-hidden ${
          ...
          <div className="relative">
            ...
            {/* User Dropdown */}
            {userMenuOpen && (
              <div className={`absolute right-0 mt-2 w-48 rounded-lg shadow-lg border overflow-hidden ${
                darkMode ? 'bg-gray-800 border-gray-700' : 'bg-white border-gray-200'
              }`}>
                <div className={`px-4 py-3 border-b ${
                  darkMode ? 'border-gray-700' : 'border-gray-200'
